...
dataloader = DataLoader(facial_expression_dataset, batch_size=24, shuffle=False, num_workers=4)
...
model = train_model(model, criterion, optimizer, exp_scheduler, num_epochs=25)
